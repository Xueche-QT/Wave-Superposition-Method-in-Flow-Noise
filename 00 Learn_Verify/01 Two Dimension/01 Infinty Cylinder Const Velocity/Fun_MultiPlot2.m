 ...
 *              YLabel                          纵轴标签                              字符串
 *              Title                           图谱标题                              字符串
 *              Axis_Option                     判断坐标轴是否等比例                   bool
 *                  true    axis equal          坐标轴等比例
 *                  flase                       坐标轴比例自动
...
function [] = Fun_MultiPlot2(Plot_Selection, X_Series, Y_Series, XLabel, YLabel, Title, Axis_Option, Grid_Option, X_Min, X_Max, Y_Min, Y_Max, Linetype, LineColor, LineWidth)
